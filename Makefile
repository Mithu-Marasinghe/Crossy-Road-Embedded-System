...
game.out: game.o system.o pio.o navswitch.o pacer.o timer.o ir_uart.o timer0.o usart1.o prescale.o tinygl.o display.o ledmat.o font.o player.o environment.o logic.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
